...
3. Implement CLI flags and loader integration, ensuring existing workflows keep working without extra arguments.
4. Backfill sparse/vintage personalities leveraging value builders and condition overlays.
